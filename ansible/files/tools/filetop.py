...
while 1:
    ...
    for k, v in reversed(sorted(counts.items(),
        ...
        if line >= maxrows:
            break
        obj = { "TIME": strftime("%H:%M:%S"), "LOADAVG": stats_read, "TID": k.pid, "COMM": k.comm.decode('utf-8', 'replace'),
        "READS":  v.reads, "WRITES": v.writes, "R_Kb":  v.rbytes / 1024 , "W_Kb": v.wbytes / 1024, "T":  k.type.decode('utf-8', 'replace'), "FILE": name}
        print(obj)
