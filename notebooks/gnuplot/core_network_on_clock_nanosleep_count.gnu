...
set term png
set output 'core_network_on_clock_nanosleep_count.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Core network syscall clock_nanosleep (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:4] "core_network_on_clock_nanosleep_count.csv" u 1:i t columnhead lc rgb word(colors, i-1)