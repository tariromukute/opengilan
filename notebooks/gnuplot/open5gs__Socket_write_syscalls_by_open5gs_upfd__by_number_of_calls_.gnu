...
set term png
set output 'open5gs__Socket_write_syscalls_by_open5gs_upfd__by_number_of_calls_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "open5gs: Socket write syscalls by open5gs-upfd (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:2] "open5gs__Socket_write_syscalls_by_open5gs_upfd__by_number_of_calls_.csv" u 1:i t columnhead lc rgb word(colors, i-1)