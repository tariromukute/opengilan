...
set term png
set output 'open5gs_sysprocess_avg.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "open5gs: Top 6 active processes making syscall (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:7] "open5gs_sysprocess_avg.csv" u 1:i t columnhead lc rgb word(colors, i-1)