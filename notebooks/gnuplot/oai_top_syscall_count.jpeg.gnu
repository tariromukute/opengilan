...
set term png
set output 'oai_top_syscall_count.jpeg.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Top 10 active syscalls oai (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:11] "oai_top_syscall_count.jpeg.csv" u 1:i t columnhead lc rgb word(colors, i-1)