...
set term png
set output 'core_network_on_recvfrom_avg.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Core network syscall recvfrom (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:4] "core_network_on_recvfrom_avg.csv" u 1:i t columnhead lc rgb word(colors, i-1)