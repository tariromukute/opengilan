...
set term png
set output 'free5gc_sysprocess_count.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Top 6 active processes making syscall free5gc (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:7] "free5gc_sysprocess_count.csv" u 1:i t columnhead lc rgb word(colors, i-1)