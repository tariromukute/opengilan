...
set term png
set output 'cn_perf_time_to_completion.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Total time to UEs completion"
...
plot for [i=2:4] "cn_perf_time_to_completion.csv" u 1:i t columnhead lc rgb word(colors, i-1)