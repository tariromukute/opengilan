...
set term png
set output 'free5gc__File_operation_syscalls_by_nrf__by_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: File operation syscalls by nrf (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:3] "free5gc__File_operation_syscalls_by_nrf__by_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)