...
set term png
set output 'free5gc__IO_Multiplexing_syscalls_by_nrf__by_average_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: IO Multiplexing syscalls by nrf (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:2] "free5gc__IO_Multiplexing_syscalls_by_nrf__by_average_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)