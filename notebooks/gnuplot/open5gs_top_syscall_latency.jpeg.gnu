...
set term png
set output 'open5gs_top_syscall_latency.jpeg.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Top 10 active syscalls oai (by average latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:11] "open5gs_top_syscall_latency.jpeg.csv" u 1:i t columnhead lc rgb word(colors, i-1)