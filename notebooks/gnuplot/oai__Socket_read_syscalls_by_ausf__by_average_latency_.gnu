...
set term png
set output 'oai__Socket_read_syscalls_by_ausf__by_average_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "oai: Socket read syscalls by ausf (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:3] "oai__Socket_read_syscalls_by_ausf__by_average_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)