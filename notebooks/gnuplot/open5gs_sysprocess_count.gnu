...
set term png
set output 'open5gs_sysprocess_count.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Top 6 active processes making syscall open5gs (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:7] "open5gs_sysprocess_count.csv" u 1:i t columnhead lc rgb word(colors, i-1)