...
set term png
set output 'oai__File_operation_syscalls_by_systemd_tty_ask__by_average_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "oai: File operation syscalls by systemd-tty-ask (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:2] "oai__File_operation_syscalls_by_systemd_tty_ask__by_average_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)