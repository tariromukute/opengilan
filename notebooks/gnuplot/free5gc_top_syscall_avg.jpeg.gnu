...
set term png
set output 'free5gc_top_syscall_avg.jpeg.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Top 10 active syscalls free5gc (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:11] "free5gc_top_syscall_avg.jpeg.csv" u 1:i t columnhead lc rgb word(colors, i-1)