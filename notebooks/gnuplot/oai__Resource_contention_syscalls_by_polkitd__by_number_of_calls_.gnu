...
set term png
set output 'oai__Resource_contention_syscalls_by_polkitd__by_number_of_calls_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "oai: Resource contention syscalls by polkitd (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:2] "oai__Resource_contention_syscalls_by_polkitd__by_number_of_calls_.csv" u 1:i t columnhead lc rgb word(colors, i-1)