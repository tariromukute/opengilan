...
set term png
set output 'free5gc__Sleep_syscalls_by_upf__by_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: Sleep syscalls by upf (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:2] "free5gc__Sleep_syscalls_by_upf__by_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)