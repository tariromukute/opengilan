...
set term png
set output 'oai__Sleep_syscalls_by_nrf__by_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "oai: Sleep syscalls by nrf (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:2] "oai__Sleep_syscalls_by_nrf__by_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)