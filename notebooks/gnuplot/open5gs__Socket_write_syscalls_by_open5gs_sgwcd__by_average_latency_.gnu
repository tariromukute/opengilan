...
set term png
set output 'open5gs__Socket_write_syscalls_by_open5gs_sgwcd__by_average_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "open5gs: Socket write syscalls by open5gs-sgwcd (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:2] "open5gs__Socket_write_syscalls_by_open5gs_sgwcd__by_average_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)