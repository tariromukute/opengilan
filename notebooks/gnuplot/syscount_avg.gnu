...
set term png
set output 'syscount_avg.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "System calls across the system (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:4] "syscount_avg.csv" u 1:i t columnhead lc rgb word(colors, i-1)