...
set term png
set output 'syscount_latency.png'
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Syscalls across the system (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:4] "syscount_latency.csv" u 1:i t columnhead lc rgb word(colors, i-1)