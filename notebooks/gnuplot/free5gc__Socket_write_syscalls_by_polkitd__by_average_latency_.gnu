...
set term png
set output 'free5gc__Socket_write_syscalls_by_polkitd__by_average_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: Socket write syscalls by polkitd (by average latency)"
...
set ylabel "Average time per syscall (ms)"
 ...
 plot for [i=2:2] "free5gc__Socket_write_syscalls_by_polkitd__by_average_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)