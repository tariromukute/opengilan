...
set term png
set output 'core_network_on_recvfrom_latency.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "Core network syscall recvfrom (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:4] "core_network_on_recvfrom_latency.csv" u 1:i t columnhead lc rgb word(colors, i-1)