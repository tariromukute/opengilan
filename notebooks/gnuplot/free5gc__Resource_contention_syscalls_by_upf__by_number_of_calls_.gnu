...
set term png
set output 'free5gc__Resource_contention_syscalls_by_upf__by_number_of_calls_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: Resource contention syscalls by upf (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:2] "free5gc__Resource_contention_syscalls_by_upf__by_number_of_calls_.csv" u 1:i t columnhead lc rgb word(colors, i-1)