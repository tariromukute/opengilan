...
set term png
set output 'open5gs__Socket_write_syscalls_by_open5gs_nrfd__by_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "open5gs: Socket write syscalls by open5gs-nrfd (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:2] "open5gs__Socket_write_syscalls_by_open5gs_nrfd__by_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)