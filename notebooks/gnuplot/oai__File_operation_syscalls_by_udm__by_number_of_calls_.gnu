...
set term png
set output 'oai__File_operation_syscalls_by_udm__by_number_of_calls_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "oai: File operation syscalls by udm (by number of calls)"
...
set ylabel "Number of calls"
 ...
 plot for [i=2:3] "oai__File_operation_syscalls_by_udm__by_number_of_calls_.csv" u 1:i t columnhead lc rgb word(colors, i-1)