...
set term png
set output 'free5gc__IO_Multiplexing_syscalls_by_pcf__by_latency_.png'
set key noenhanced
set key top left
set key autotitle columnhead
set datafile separator ','
set title "free5gc: IO Multiplexing syscalls by pcf (by latency)"
...
set ylabel "Time (ms)"
 ...
 plot for [i=2:2] "free5gc__IO_Multiplexing_syscalls_by_pcf__by_latency_.csv" u 1:i t columnhead lc rgb word(colors, i-1)